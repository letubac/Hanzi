        ...
        >
          {success ? (
            <div className="text-center py-4">
              <CheckCircle2 className="h-14 w-14 mx-auto mb-3" style={{ color: '#00C8D4' }} />
              <h2 className="text-xl font-bold mb-1 text-white">Account Created!</h2>
              <p className="text-white/50 text-sm">Check your email to confirm, then sign in.</p>
            </div>
          ) : (
            <>
              <h2 className="text-xl font-bold text-center mb-1 text-white">Join SuperHanzi</h2>
              <p className="text-center text-sm text-white/50 mb-5">Start your Chinese learning journey</p>
